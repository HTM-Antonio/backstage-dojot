...
const config = {
  ...
  postgres_database:
    process.env.DEVICE_MANAGER_POSTGRES_DATABASE || "dojot_devm",
  ...
  postgres_backstage_database:
    process.env.BACKSTAGE_DASBOARD_DB_NAME || "dojot_dash_users",
  postgres_backstage_user:
    process.env.BACKSTAGE_DASHBOARD_DB_USER || "postgres",
  postgres_backstage_pwd:
    process.env.BACKSTAGE_DASHBOARD_DB_PASSWORD || "postgres",
  postgres_backstage_host:
    process.env.BACKSTAGE_DASHBOARD_DB_HOST || "postgres",
